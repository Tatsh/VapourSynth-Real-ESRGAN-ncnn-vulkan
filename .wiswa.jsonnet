...

{
  ...
  github+: {
    // Meson and Wheels are hand-maintained workflows (not generated by Wiswa)
    // that must succeed before publishing, mirroring scenechange.
    workflows+: {
      release_gate_workflows: ['Meson', 'Wheels'],
    },
  },
  package_json+: {
    cspell+: {
